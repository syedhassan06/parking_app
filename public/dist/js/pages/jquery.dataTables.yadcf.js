				...
				if (args.hasOwnProperty(columnObjKey)) {
					...
					if ($filter_selector.length === 1) {
						...
						if (columnObj.filter_type === "select" || columnObj.filter_type === 'custom_func') {
							...
							//add a wrapper to hold both filter and reset button
							$(filter_selector_string).append("<div id=\"yadcf-filter-wrapper-" + table_selector_jq_friendly + "-" + column_number + "\" class=\"yadcf-filter-wrapper  form-group position-relative\"></div>");
							filter_selector_string += " div.yadcf-filter-wrapper";
							...
							if (columnObj.filter_type === "select") {
								...
								$(filter_selector_string).append("<select id=\"yadcf-filter-" + table_selector_jq_friendly + "-" + column_number + "\" class=\"yadcf-filter form-control form-control-sm input-sm" + columnObj.style_class + "\" " +
								...
								if (filter_reset_button_text !== false) {
									$(filter_selector_string).find(".yadcf-filter").after("<button type=\"button\" " +
										"id=\"yadcf-filter-" + table_selector_jq_friendly + "-" + column_number + "-reset\" onmousedown=\"yadcf.stopPropagation(event);\" onclick=\"yadcf.stopPropagation(event);yadcf.doFilter('clear', '" + table_selector_jq_friendly + "', " + column_number + "); return false;\" class=\"yadcf-filter-reset-button form-control-position input-yadcf-btn-right-icon" + columnObj.reset_button_style_class + "\">" + filter_reset_button_text + "</button>");
								}
							} else {
								...
								if (filter_reset_button_text !== false) {
									$(filter_selector_string).find(".yadcf-filter").after("<button type=\"button\" onmousedown=\"yadcf.stopPropagation(event);\" " +
										"onclick=\"yadcf.stopPropagation(event);yadcf.doFilterCustomDateFunc('clear', '" + table_selector_jq_friendly + "', " + column_number + "); return false;\" class=\"yadcf-filter-reset-button form-control-position input-yadcf-btn-right-icon" + columnObj.reset_button_style_class + "\">" + filter_reset_button_text + "</button>");
								}
							...
							if (filter_reset_button_text !== false) {
								$(filter_selector_string).find(".yadcf-filter").after("<button type=\"button\" " + " id=\"yadcf-filter-" + table_selector_jq_friendly + "-" + column_number + "-reset\" onmousedown=\"yadcf.stopPropagation(event);\" " +
									"onclick=\"yadcf.stopPropagation(event);yadcf.textKeyUP(event,'" + table_selector_jq_friendly + "', '" + column_number + "', 'clear'); return false;\" class=\"yadcf-filter-reset-button form-control-position input-yadcf-btn-right-icon" + columnObj.reset_button_style_class + "\">" + /*filter_reset_button_text*/"" + "</button>");
							}
	...
	*/
		...
		function textKeyUP(ev, table_selector_jq_friendly, column_number, clear) {
			...
			keyUp = function (table_selector_jq_friendly, column_number, clear) {
				...
				$.fn.dataTableExt.iApiIndex = oTablesIndex[table_selector_jq_friendly];
				//console.log('$(fixedPrefix + "#yadcf-filter-" + table_selector_jq_friendly + "-" + column_number)',$(fixedPrefix + "#yadcf-filter-" + table_selector_jq_friendly + "-" + column_number).val());
				if (clear === 'clear' || $(fixedPrefix + "#yadcf-filter-" + table_selector_jq_friendly + "-" + column_number).val() === '') {
					//--------------Custom Changes Comment--------------------------------------
